...
export class NetworkService {
  ...
  // network calls for rating
  submitRatings(data: any) {
    return this.httpPostResponse('yearly-rating', data);
  }

  // getting past ratings according to category
  getPastRatings(category: any) {
    return this.httpGetResponse('yearly-rating?categoryName=' + category);
  }
